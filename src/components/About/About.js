        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="about-me-description col-md-6">
              ...
              <p>This year I started studying JavaScript to improve my knowledge and be able to implement completely web interfaces.<br /><br /> I love to structure my work to point to top quality elements. Always trying to find a balance between what is beautiful and chatchy and what is functional.<br /><br />
